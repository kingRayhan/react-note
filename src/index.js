...
const Note = ({ bgColor = '#fff' }) => (
    <div className="note" style={{ backgroundColor: bgColor }}>
        <div>
            ...
            <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Architecto dolorem ea fugiat ad maiores
                distinctio impedit dignissimos possimus blanditiis veritatis eligendi earum dolorum commodi quasi quam
                a, incidunt illo. Illum.
            </p>
        </div>
